...
import { faArrowLeft, faSave, faTable } from '@fortawesome/free-solid-svg-icons';
...
export default function Home() {
    ...
    const saveResultsToDatabase = async () => {
        try {
            ...
            const response = await fetch('/api/saveData2', {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            ...
            <div className="calculator-title">
                <h2 className="mt-5 mb-4 text-center">MTBF & MTTR Calculator LINE 2</h2>
            </div>
            ...
            <div className="container" id="form-input">
                ...
                <div className="row">
                    <div className="col-md-12 text-center">
                        <Link href="/">
                            <div className="btn btn-secondary mt-4 me-2">
            ...
            <div className="total-container" id="total-container">
                <h4>Total for 24 Hours</h4>
                <p>Total Failures: <span>{totalData.failures}</span></p>
                <p>Total Downtime: <span>{totalData.downtime}</span></p>
                <p>Total MTBF: <span>{totalData.mtbf}</span> minutes</p>
                <p>Total MTTR: <span>{totalData.mttr}</span> minutes</p>
            </div>
        </>
    );
}
